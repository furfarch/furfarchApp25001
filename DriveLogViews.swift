...
// ChecklistEditorView and ChecklistItemRow are implemented in `ChecklistViews.swift`.
// Keep a single shared implementation there to avoid duplicate declarations.
